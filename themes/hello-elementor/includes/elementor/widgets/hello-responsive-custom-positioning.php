<?php
class Builder_Responsive_Custom_Positioning extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'builder-responsive-custom-positioning';
	}
	...
	public function register_controls( $element, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'label' => __( 'Responsive Custom Positioning', 'pafe' ),
...
new Builder_Responsive_Custom_Positioning();