...
function register_post_types(){
    register_post_type( 'property', [
        ...
        'labels' => [
            ...
            'add_new_item'       => 'Add properties', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => 'Edit property', // для редактирования типа записи
            'new_item'           => 'New property', // текст новой записи
            'view_item'          => 'Look property', // для просмотра записи этого типа.
            'search_items'       => 'Search properties', // для поиска по этим типам записи
