<div class="hl-listing-card hl-listing-card hl-listing-card_hover">
  <div class="hl-listing-card__picture">
    ...
    <div class="hl-listing-card__location">
      <span class="hl-listing-card__icon hl-listing-card__location-icon"></span>
      <a class="hl-listing-card__location-item" href="#">Shinjuku,</a>
      <a class="hl-listing-card__location-item" href="#">Tokyo</a>
    </div>

<!--    <a class="hl-listing-card__picture-wrap-img" href="#">-->
<!--      <picture class="hl-listing-card__picture-img-picture">-->
...
<!--    </a>-->
  ...
  <div class="hl-listing-card__body">
    <h4 class="hl-listing-card__title">
      <a href="#">
    ...
    <ul class="hl-listing-card__info">
      <li class="hl-listing-card__info-item">
        <span class="hl-listing-card__icon hl-listing-card__info-icon"></span>
        <span class="hl-listing-card__info-value">5</span>
      </li>

      <li class="hl-listing-card__info-item">
        <span class="hl-listing-card__icon hl-listing-card__info-icon"></span>
        <span class="hl-listing-card__info-value">6</span>
      </li>
